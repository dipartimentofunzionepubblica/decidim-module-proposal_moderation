  ...
  module Amendable
    ...
    def visible_emendations_for(user)
      ...
      if component.current_settings.moderation_amendment_enabled
        published_emendations = published_emendations.not_in_moderation_rejected.not_in_review.or(published_emendations.in_moderation_rejected_for_user(user).or(published_emendations.in_review_for_user(user)))
